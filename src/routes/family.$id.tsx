                  ...
                  <li key={t.id} className="py-3 flex items-center gap-3 group">
                    ...
                    <button
                      onClick={async () => {
                        ...
                        if (error) { showToast("Couldn't delete"); refresh(); } else showToast("Deleted");
                      }}
                      aria-label="Delete expense"
                      className="ml-1 size-8 grid place-items-center rounded-full text-muted-foreground hover:text-[var(--color-danger)] hover:bg-muted transition-colors active:scale-90"
                    >
